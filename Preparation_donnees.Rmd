...
knitr::include_graphics(rep("images/image.png", 4))
...
```{r WORLD, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r JOIN, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
...
```{r JOIN TOTALS, echo=TRUE, message=FALSE, warning=FALSE, results='hide'}
