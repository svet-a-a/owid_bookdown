...
1. In the Console, type `usethis::use_git()` and say Yes to the two prompts. This will restart R and give you a new Git tab in the upper right pane.
1. Now, click on the Terminal tab next to the Console tab. 
1. Type git remote add cheese https://github.com/oswaldoforey/truc.git`
1. Type `git push --set-upstream cheese master`
1. Go back to github.com/username/"awesome-book" and refresh — our files should be there! But we want it to be a book published as https://username.github.io/awesome-book.
1. Click Settings
1. sur le coté cliquer dans page
1. Change the Source pulldown from "None" to "master branch /docs folder"
1. It should say "Your site is ready to be published at https://username.github.io/awesome-book/" — click the link to see but error page
- effacer le readme, le bouton environnement en bas à droite de la page avec une fusée apparait
- cliquer dessus ça marche
- faire des modif, cliquer sur build book puis dans l'onglet git sur Diff
